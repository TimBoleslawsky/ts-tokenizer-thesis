...
{\Large Tim Boleslawsky} \setlength{\parskip}{2.9cm} \\
{\Large Emrik Dunvald} \setlength{\parskip}{2.9cm}
...
\oneLineTitle\\
\oneLineSubtitle\\
Tim Boleslawsky \setlength{\parskip}{1cm} \\
Emrik Dunvald \setlength{\parskip}{1cm}

\copyright ~ Tim Boleslawsky, Emrik Dunvald, \the\year. \setlength{\parskip}{1cm}
