...
The two dimensions along wich each of the neural compression methods are evaluated are compressione performance and downstream task performance, as outlined in Chapter~\ref{chap:methods}. In this section all methods will 
