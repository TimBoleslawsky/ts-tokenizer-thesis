...
% make the performance the deduction from the data
% give a better reason for why we only build on the edgecpdec
% clarigy why the edgecodec is better
