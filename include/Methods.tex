...
Table~\ref{tab:compression-ratios-emob} presents the computed CR for the three architectures evaluated on the Volvo EMOB dataset, demonstrating that the architectures achieve comparable compression performance despite their different internal configurations.
...
Similarly, Table~\ref{tab:compression-ratios-appliances} shows the computed CR for the appliances energy dataset. Despite the larger number of channels and longer window size compared to the EMOB dataset, all three architectures maintain comparable compression performance, achieving between 240$\times$ and 230$\times$ compression.
